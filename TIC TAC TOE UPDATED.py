...
for i in range (0,9):
        ...
        if (L1[0]== L1[1] == L1[2] or L2[0] == L2[1] == L2[2] or L3[0] == L3[1] == L3[2] or L1[0] == L2[0] == L3[0] or L1[1] == L2[1]== L3[1] or L1[2]== L2[2]== L3[2] or L1[0]== L2[1] == L3[2] or L1[2] == L2[1] == L3[0]):
            if (L1[0]== L1[1] == L1[2] == 'X' or L2[0] == L2[1] == L2[2] == 'X' or L3[0] == L3[1] == L3[2] == 'X' or L1[0] == L2[0] == L3[0] == 'X' or L1[1] == L2[1]== L3[1]== 'X' or L1[2]== L2[2]== L3[2] == 'X' or L1[0]== L2[1] == L3[2]=='X' or L1[2] == L2[1] == L3[0]== 'X'):
